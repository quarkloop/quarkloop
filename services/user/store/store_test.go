...
func TestMutationOnCreateUser(t *testing.T) {
	...
	t.Run("create user", func(t *testing.T) {
		...
		{
			// check the update
			query := &GetUserByIdQuery{UserId: u.Id}
...
func TestQueryOnUser(t *testing.T) {
	...
	t.Run("get user by wrong id", func(t *testing.T) {
		u, err := store.GetUserById(ctx, &GetUserByIdQuery{UserId: 99999})
...
func TestQueryOnSession(t *testing.T) {
	...
	t.Run("list sessions", func(t *testing.T) {
		...
		for _, u := range userList {
			list, err := store.GetSessionsByUserId(ctx, &GetSessionsByUserIdQuery{UserId: u.Id})
	...
	t.Run("get session by wrong id", func(t *testing.T) {
		list, err := store.GetSessionsByUserId(ctx, &GetSessionsByUserIdQuery{UserId: 99999})
...
func TestQueryOnAccount(t *testing.T) {
	...
	t.Run("list accounts", func(t *testing.T) {
		...
		for _, u := range userList {
			list, err := store.GetAccountsByUserId(ctx, &GetAccountsByUserIdQuery{UserId: u.Id})
	...
	t.Run("get account by wrong id", func(t *testing.T) {
		list, err := store.GetAccountsByUserId(ctx, &GetAccountsByUserIdQuery{UserId: 99999})
...
func TestMutationOnDeleteSession(t *testing.T) {
	...
	t.Run("delete session by wrong id", func(t *testing.T) {
		...
		for _, u := range userList {
			cmd := &DeleteSessionByIdCommand{UserId: u.Id, SessionId: 99999}
	...
	t.Run("delete session by id", func(t *testing.T) {
		...
		for _, u := range userList {
			cmd := &DeleteSessionByIdCommand{UserId: u.Id, SessionId: sessionId}
			err := store.DeleteSessionById(ctx, cmd)
...
func TestMutationOnDeleteAccount(t *testing.T) {
	...
	t.Run("delete account by wrong id", func(t *testing.T) {
		...
		for _, u := range userList {
			cmd := &DeleteAccountByIdCommand{UserId: u.Id, AccountId: 99999}
	...
	t.Run("delete account by id", func(t *testing.T) {
		...
		for _, u := range userList {
			cmd := &DeleteAccountByIdCommand{UserId: u.Id, AccountId: accountId}
			err := store.DeleteAccountById(ctx, cmd)
...
func TestMutationOnDeleteUser(t *testing.T) {
	...
	t.Run("delete user by id", func(t *testing.T) {
		...
		for _, u := range userList {
			cmd := &DeleteUserByIdCommand{UserId: u.Id}
